...
import { useUpdateAdminMutation } from "@/redux/superAdminRedux/superAdminAPI"
...
export default function UpdateAdminModal({ open, admin, onClose, onUpdate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.subscriptionDate) updateData.subscriptionDate = formData.subscriptionDate

      // ✅ Call RTK Query mutation
      await updateAdmin({ adminId: admin._id, updateData }).unwrap()

      showMessage("Admin updated successfully!")
      onUpdate(admin._id, updateData)
